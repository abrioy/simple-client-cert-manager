...
export default function App(): JSX.Element {
  ...
  const performEnrollment = useCallback(
    async (token: string) => {
      ...
      try {
        ...
        const url = new URL(config.enrollmentEndpoint, window.location.origin);
  ...
  return (
    <main className="app">
      ...
      <p>
        Generate a fresh key pair in your browser, complete an OIDC sign-in, and ask step-ca to sign a certificate without ever
